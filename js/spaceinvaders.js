...
WelcomeState.prototype.draw = function(game, dt, ctx) {
    ...
    ctx.fillText("Aperte 'Espaço' para iniciar.", game.width / 2, game.height/2); 
};
...
GameOverState.prototype.draw = function(game, dt, ctx) {
    ...
    ctx.font="25px Arial";
    ctx.fillText("Sua pontuação foi " + game.score + " e você alcançou o level " + game.level, game.width / 2, game.height/2);
    ctx.font="16px Arial";
    ctx.fillText("Aperte 'Espaço' para jogar novamente.", game.width / 2, game.height/2 + 40);
	$("#botao").html("<button type='button' class='btn btn-primary btn-lg' data-toggle='modal' data-target='#myModal'>Compartilhar</button>");
...
PlayState.prototype.draw = function(game, dt, ctx) {
    ...
    ctx.drawImage(nave,this.ship.x - (this.ship.width / 2), this.ship.y - (this.ship.height / 2), this.ship.width, this.ship.height);
    ...
    for(var i=0; i<this.invaders.length; i++) {
        var invader = this.invaders[i];
		ctx.drawImage(img,invader.x - invader.width/2, invader.y - invader.height/2, invader.width, invader.height);
    }
	...
	var vida = new Image();
	vida.src = "vida.png";
	vida.onload = function() {};
    var textYpos = game.gameBounds.bottom + ((game.height - game.gameBounds.bottom) / 2) + 14/2;
    ctx.font="20px Arial";
    ctx.fillStyle = '#ffffff';
    var info = "Vidas: " + game.lives;
	ctx.drawImage(vida, game.gameBounds.left+80, textYpos-11, 20,20);
    ctx.textAlign = "left";
    ctx.fillText(info, game.gameBounds.left, textYpos);
    info = "Pontuação: " + game.score + "    Level: " + game.level;
    ctx.textAlign = "right";
...
LevelIntroState.prototype.draw = function(game, dt, ctx) {
    ...
    ctx.textBaseline="middle"; 
    ctx.textAlign="center"; 
    ctx.fillText("Nível " + this.level, game.width / 2, game.height/2);
    ctx.font="24px Arial";
...
Sounds.prototype.loadSound = function(name, url) {
    ...
    try {
      ...
      console.log("Ocorreu um erro com o som " + name + " isso pode ser " +
         "porque a página está rodando de um arquivo, e não de um server.");
      console.log(e);
    }
};
